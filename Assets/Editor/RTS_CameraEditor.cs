...
namespace Editor
{
    [CustomEditor(typeof(RTS_CameraManager))]
    public class RTS_CameraEditor : UnityEditor.Editor
    {
        private RTS_CameraManager camera { get { return target as RTS_CameraManager; } }

        private TabsBlock tabs;
        private float MenuWidth = 170;
        ...
        {
            //base.OnInspectorGUI();
            Undo.RecordObject(camera, "RTS_CameraManager");
            tabs.Draw();
            if (GUI.changed)
        ...
        private void MovementTab()
        {
            ...
            {
                GUILayout.Label("Use keyboard input: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
            ...
            using (new HorizontalBlock())
            {
                GUILayout.Label("Screen edge input: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
            ...
            using (new HorizontalBlock())
            {
                GUILayout.Label("Panning with mouse: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
            ...
            using (new HorizontalBlock())
            {
                GUILayout.Label("Limit movement: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
        ...
        private void RotationTab()
        {
            using (new HorizontalBlock())
            {
                GUILayout.Label("Keyboard input: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
            ...
            using (new HorizontalBlock())
            {
                GUILayout.Label("Mouse input: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
            ...
            if(camera.useMouseRotation)
            {
                ...
                using (new HorizontalBlock())
                {
                    GUILayout.Label("Mouse secondary key: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
        ...
        private void HeightTab()
        {
            using (new HorizontalBlock())
            {
                GUILayout.Label("Auto height: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
            ...
            using (new HorizontalBlock())
            {
                GUILayout.Label("Keyboard zooming: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
            ...
            using (new HorizontalBlock())
            {
                GUILayout.Label("Scrollwheel zooming: ", EditorStyles.boldLabel, GUILayout.Width(MenuWidth));
